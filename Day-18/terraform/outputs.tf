...
output "sns_topic_arn" {
  ...
  value       = var.notification_email != "" ? aws_sns_topic.processing_notifications[0].arn : "Not configured"
}

output "notification_email" {
  description = "Email address receiving notifications (if configured)"
